...
EXPERIMENT_NAME="qwen3b_1e-6_32_rollouts_instruct_test"
PROJECT_NAME='confidence_after_answer_triviaqa_1.5b'

python3 -m verl.trainer.main_ppo \
 algorithm.adv_estimator=grpo \
 data.train_files=$HOME/rlvr/rlvr_train.parquet \
 data.val_files=$HOME/rlvr/rlvr_validation.parquet \
