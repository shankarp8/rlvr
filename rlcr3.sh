...
python3 -m verl.trainer.main_ppo \
 ...
 data.train_files=$HOME/rlvr/rlcr_pqa_nothink_0or1_balanced_train.parquet \
 data.val_files=$HOME/rlvr/rlcr_pqa_nothink_0or1_balanced_validation.parquet \
...
#  data.val_files=$HOME/rlvr/rlcr_pqa_cfirst_kinda_balanced_validation2.parquet \

#  data.train_files=$HOME/rlvr/rlcr_pqa_clast_kinda_balanced_train.parquet \
#  data.val_files=$HOME/rlvr/rlcr_pqa_clast_kinda_balanced_validation.parquet \
...
#  actor_rollout_ref.rollout.temperature=1.0 \
#  +actor_rollout_ref.rollout.val_temperature=0.5 \
# #  +actor_rollout_ref.rollout.num_engines=2
# #  +actor_rollout_ref.rollout.ray_actor_num_gpus=1
#  actor_rollout_ref.rollout.max_num_batched_tokens=16384 \
